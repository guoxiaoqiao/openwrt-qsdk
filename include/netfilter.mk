...
# conntrack-qos
$(eval $(call nf_add,IPT_CONNTRACK_QOS,CONFIG_NETFILTER_XT_TARGET_DSCPREMARK, $(P_XT)xt_DSCPREMARK))
$(eval $(call nf_add,IPT_CONNTRACK_QOS,CONFIG_NETFILTER_XT_TARGET_VLANTAG, $(P_XT)xt_VLANTAG))
...
IPT_BUILTIN += $(IPT_CONNTRACK_QOS-y)
